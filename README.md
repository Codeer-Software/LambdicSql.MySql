LambdicSql for MySql_β 0.2.0
======================

## Features ...
LambdicSql is ultimate sql builder.<br>
Generate sql text and parameters from lambda. <br>
We will make it possible to represent as many MySql clause and functions as possible in C #. <br>
...
https://www.nuget.org/packages/LambdicSql.MySql/<br>
...
namespace Sample
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //test.
            using (var cnn = new MySqlConnection("your connection string")) Sample(cnn);
        }
